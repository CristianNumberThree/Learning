...
class QuizApp:
    def __init__(self, master):
        ...
        # Create entry widgets for name and age
    ...
    def setup_quiz_data(self):
        ...
        self.PreferenceList = ["Artoria Pendragon", "Loyd Forger", "Levi Ackerman", "Kyo Sohma", "Kakashi Hatake",
    ...
    def display_reversed_name(self):
        # The easter egg feature its better in the full version
